...
class STDMAERunner(BaseTimeSeriesForecastingRunner):
    ...
    def forward(self, data: tuple, epoch:int = None, iter_num: int = None, train:bool = True, **kwargs) -> tuple:
        ...
        history_data = history_data.to(self.device)  # B, L, N, C
        long_history_data = long_history_data.to(self.device)  # B, L, N, C
        future_data = future_data.to(self.device)  # B, L, N, C
